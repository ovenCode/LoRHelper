    ...
    public static class HostBuilderExtensions
    {
        ...
        public static IHostBuilder AddViewModels(this IHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                services.AddSingleton(new HttpClientFactory([]));
        ...
        private static ProfileViewModel CreateProfilePageViewModel(IServiceProvider serviceProvider)
        {
            return ProfileViewModel.LoadViewModel(
                ...
                serviceProvider.GetRequiredService<ProfileStore>(),
                serviceProvider.GetRequiredService<NavigationService<InGameViewModel>>(),
                serviceProvider.GetRequiredService<NavigationService<InfoViewModel>>(),
